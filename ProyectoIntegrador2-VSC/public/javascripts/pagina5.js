     ...
     fetch("https://api.themoviedb.org/3/movie/" + idPelicula + "/recommendations?api_key=d6ff71a6bd2a94eaac5b986a9112d505&page=1")
        ...
        .then (function(information){
         ...
         for (var i = 0; i < arrayDePeliculas.length; i++) {
            ...
            document.querySelector("ul#popular").innerHTML += "<p><a href='/peliculas/detalle?idPelicula="+id+"'> <img id='poster' class=uk-align-center src=https://image.tmdb.org/t/p/w500" + poster + " 'uk-cover'> </a></p>"
      }
    })
