...
// UN FOR POR CADA GÉNERO
      for (var i = 0; i < arrayPeliculasPorGenero.length; i++) {
        ...
        document.querySelector("ul#genero").innerHTML += "<li> <a href='/peliculas/detalle?idPelicula="+ id+ "'> <img class=uk-align-center src=https://image.tmdb.org/t/p/w500" + poster + " 'uk-cover'> </a> </li>"
